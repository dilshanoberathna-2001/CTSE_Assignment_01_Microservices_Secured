...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (!oidcCode || oidcExchangeStarted.current) {
      return;
    }
    ...
    const completeGoogleLogin = async () => {
      ...
      try {
        const res = await api.exchangeOidcCode(oidcCode);
  ...
  return (
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden bg-black">
      <div className="absolute inset-0 z-0">
        <img
          src="https://assets.nflxext.com/ffe/siteui/vlv3/4da5d2b1-1b22-498d-90c0-4d86701dffcc/98a1cb1e-5a1d-4b98-a46f-995272a632dd/US-en-20240129-popsignuptwoweeks-perspective_alpha_website_large.jpg"
          className="h-full w-full object-cover opacity-50 block"
        ...
        <div className="bg-black/80 px-10 py-16 rounded-lg backdrop-blur-sm shadow-2xl">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className={`w-full font-bold text-white bg-netflix hover:bg-netflixHover px-4 py-3 rounded-md transition ${
          ...
          <button
            ...
            disabled={loading || googleLoading}
            className={`w-full flex items-center justify-center gap-3 font-semibold text-gray-900 bg-white hover:bg-gray-200 px-4 py-3 rounded-md transition ${
              loading || googleLoading
                ? 'opacity-70 cursor-not-allowed'
                : ''
            }`}
          ...
          <p className="text-xs text-gray-500 mt-4 leading-relaxed tracking-wide">
            This page is protected by invisible reCAPTCHA to ensure
            you're not a bot.
